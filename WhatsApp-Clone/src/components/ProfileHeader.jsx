...
export default function ProfileHeader() {
  ...
  return (
      ...
      <div className='ml-6 mr-1 mt-2 mb-2 pt-2 pb-2 h-28' style={{width: "450px"}}>
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
        <div className='flex items-center bg-[#343f46] mb-1 mt-1'>
          ...
          <div className='flex justify-between w-2/5' style={{marginLeft: "38%", marginRight: "10px" }}>
        ...
        <div className='flex h-10 items-center mt-1 -mb-1 justify-between'>
          <input className='mb-1' style={{ height: "28px", width: "80%", marginLeft: "10px", borderRadius: "6px", backgroundColor: "#343f46", color: "#858585", textAlign: "center" }} defaultValue="Search" type="text" name="" id="" />
